...
export const productApi = {
  ...
  // NOWOŚĆ: Walidacja koszyka
  validateCart: (data) => api.post("/products/validate-cart", data), // <-- DODAJ TO
...
export const settingApi = {
  // Pobieranie aktualnych kosztów wysyłki
  getShippingCosts: () => api.get("/settings/shipping-costs"),

  // Zapisywanie zaktualizowanych kosztów
  updateShippingCosts: (costsData) =>
